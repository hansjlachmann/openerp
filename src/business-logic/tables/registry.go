...
func init() {
	...
	RegisterTableFactory("Customer", CustomerTableID, func() ftables.Table {
		return &Customer{}
	})
	RegisterTableFactory("Payment_terms", PaymentTermsTableID, func() ftables.Table {
		return &PaymentTerms{}
	})
	RegisterTableFactory("Customer_ledger_entry", CustomerLedgerEntryTableID, func() ftables.Table {
		return &CustomerLedgerEntry{}
	})
	RegisterTableFactory("User", UserTableID, func() ftables.Table {
		return &User{}
	})
	RegisterTableFactory("User_preferences", UserPreferencesTableID, func() ftables.Table {
